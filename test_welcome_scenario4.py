#!/usr/bin/env python3
"""
Test Welcome Dialog - Scenario 4: Both NVIDIA GPU and GNOME
Shows: Base structure + Optional Features (both GNOME extension and CUDA)
"""
...
def show_welcome_scenario4():
    """Welcome dialog for users with both NVIDIA GPU and GNOME desktop"""

    dialog = Gtk.Dialog(title="Welcome to TalkType!")
    dialog.set_default_size(580, 1220)
    ...
    # ========== OPTIONAL FEATURES SECTION (BOTH GNOME AND CUDA) ==========

...
export-env {
    ...
    let virtual_env = r#'/home/ron/.cache/pypoetry/virtualenvs/ron-dictation-zz-XcKas-py3.12'#
    let bin = r#'bin'#
    ...
    let virtual_env_prompt = (if (r#'ron-dictation-py3.12'# | is-empty) {
        ($virtual_env | path basename)
    } else {
        r#'ron-dictation-py3.12'#
    })
